 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://service.sunny.org/", wsdlLocation = "http://localhost:2333/service/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://service.sunny.org/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2333/service/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://service.sunny.org/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sunny.org/", "HelloPort"), Hello.class, features);
    }
